window.DECK_SLIDES = [
  ...
  // 2 – Mercado  (NEW – PDF p.3)
  {
    ...
    cards: [
      ...
      ["AHORRO Y COMODIDAD", "Lavar fuera de casa es un 30% más barato"],
      ["Digitalización", "Adopción masiva de autogestión de servicios y pagos digitales"],
      ["Sostenibilidad", "Ahorro y sostenibilidad mediante tecnologías eficientes en agua y luz."]
    ],
    layout: "dashboard"
  },
