window.DECK_SLIDES = [
  ...
  },
  {
    ...
    steps: [
      ...
      ["2", "MODELO DE NEGOCIO", "Búsqueda de local Validación comercial y técnica del local Plan de financiación Firma contrato franquicia"],
    ...
    groups: [
      ...
      ["Proceso de Innovación", "Digital Marketing & Media Promociones Monitorización KPI Campañas a Clientes Aplicación de innovación\nNuevas funcionalidades Nuevos productos Nuevos Servicios\nMejora Continua Solución puntos dolor \nUp Selling / Cross Selling"],
      ["Feedback / Comunidad La Wash", "Llamadas periódicas \nLinea directa \nCoordinador de franquicias Eventos \nReuniones 1:1 \nAcuerdos de cadena (volumen)"],
      ["Marketing & Performance", "Resolución de incidencias Formación, retención y fidelización Comunicación y lanzamiento de innovaciones Oferta de productos y servicios"]
    ],
    layout: "process"
  },
  {
    ...
    stats: [
      ["0€", "Canon de entrada"],
      ["10", "Años de contrato"],
      ["0€", "Royalties de explotación"],
      ["40%", "ROI"]
    ],
    foot: "GARANTÍA: RECOMPRA DE TU NEGOCIO",
    layout: "metrics"
  },
  {
    section: "Modelo",
    eyebrow: "Modelo único",
    title: "NUESTRO MODELO ÚNICO",
  ...
  },
  {
    ...
    cards: [
      ["Conoce e incentiva a tu consumidor", "Crear una relación continua con el consumidor para incrementar su frecuencia de uso y ticket medio de forma diferencial."],
      ["Gestión y servicios para tu negocio de forma remota y fácil", "Gestionar de forma remota la totalidad de las operaciones de la tienda y su administración contable y financiera."],
      ["Sistema de punto de venta con capacidades inteligentes; de pago, integra promociones y upselling y gestiona las máquinas.", ""],
      ["*Customer care & success", "Adquirir productos y servicios para operar la lavandería con condiciones preferentes, trazabilidad y automatización total."]
    ],
    layout: "nexa"
  },
  {
  ...
  },
  {
    ...
    cards: [
      ...
      ["PROMOCIONES", ""],
      ["PAGO CON SCANEO QR", ""],
      ["TEMPORIZADOR y AVISO DE FIN DE SERVICIo", ""],
      ["TICKET Y FACTURA ON LINE", ""],
      ["PAGO CON MEJORES PRECIOS", ""],
      ["CAMPAÑAS EXCLUSIVAS", ""],
  ...
  },
  {
    ...
    cards: [
      ["PREMIO AL MEJOR SERVICIO DEL AÑ0", ""],
      ["PREMIO A LA MEJOR FRANQUICIA DEL AÑO", ""],
    ...
    supportImages: ["assets/source-media/image50.png", "assets/source-media/image51.png", "assets/source-media/image52.png"],
    layout: "press"
  },
  {
    section: "Prueba",
